...
class Hparams:
    ...
    # train
    ## files
    parser.add_argument('--train1', default='data/train.txt',
    ...
    parser.add_argument('--eval1', default='data/dev.txt',
    ...
    parser.add_argument('--eval3', default='data/dev_trainCWC.txt',
                             help="english evaluation unsegmented data")

    ## vocabulary
    parser.add_argument('--vocab', default='data/vocab32000',
    ...
    # test
    parser.add_argument('--test1', default='data/test.txt',
